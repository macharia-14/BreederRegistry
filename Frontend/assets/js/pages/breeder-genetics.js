// Frontend/assets/js/pages/breeder-genetics.js: controls frontend behavior for the Animal Breed Registry System.
let _females = [];
let _males = [];
let _all = [];
...
(function initMobileSidebar() {
    ...
    // Handles open behavior for this page.
    function open() {
    ...
    document.querySelectorAll('.nav-item').forEach(item =>
        item.addEventListener('click', () => { if (window.innerWidth < 900) close(); })
    );
})();

// Handles switch tab behavior for this page.
...
// Calculates coi from the selected values.
...
// Handles lookup animal coi behavior for this page.
...
// Handles get recommendations behavior for this page.
