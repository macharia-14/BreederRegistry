// Main loader for the admin animal management table
async function loadAnimals() {
  try {
    const animals = ensureArray(await apiFetch('/api/admins/animals'));
...
// Local filtering logic for the animal list
...
// Event listeners for dashboard interaction
document.addEventListener('DOMContentLoaded', () => {
  ...
  [filterAll, filterSpecies, filterBreed, filterGender, filterBreeder].forEach(filter => {
